...
function Header(props) {
  ...
  <div
    className="dropdown-body text-wrap header-notification-scroll position-relative simplebar-scrollable-y"
    ...
    <div className="simplebar-wrapper" style={{ margin: "-16px -20px" }}>
      ...
      <div className="simplebar-mask">
        <div className="simplebar-offset" style={{ right: 0, bottom: 0 }}>
          ...
          >
            <div className="simplebar-content" style={{ padding: "16px 20px" }}>
  ...
  <div className="dropdown-body">
    <div
      className="profile-notification-scroll position-relative simplebar-scrollable-y"
                  ...
                  <div className="flex-grow-1 ms-3">
                    ...
                    <span>
                      <a
                        ...
                        data-cfemail="fc9f9d8e8f9392d2989d8e8e9592bc9f93918c9d9285d29593"
                      >
                        [email&nbsp;protected]
                      </a>
                    </span>
                ...
                >
                  <div className="card-body">
                    ...
                    <a
                      ...
                      className="btn btn btn-warning buynowlinks"
                    >
                      <svg className="pc-icon me-2">
                        <use xlinkHref="#custom-logout-1-outline" />
                      </svg>
    ...
    <div className="offcanvas pc-announcement-offcanvas offcanvas-end" tabIndex="-1" id="announcement" aria-labelledby="announcementLabel">
         <div className="offcanvas-header">
            <h5 className="offcanvas-title" id="announcementLabel">What's new announcement?</h5>
         ...
         <div className="offcanvas-body">
            ...
            <div className="card mb-3">
               <div className="card-body">
                  ...
                  <p className="text-muted">Able Pro is completely renowed with high aesthetics User Interface.</p>
                  <img src="../assets/images/layout/img-announcement-1.png" alt="img" className="img-fluid mb-3" />
                  <div className="row">
            ...
            {/* <div className="card mb-3">
               <div className="card-body">
                  ...
                  <p className="text-muted">Download Able Pro exclusive on themeforest with best price.</p>
                  <a href="https://1.envato.market/zNkqj6" target="_blank"><img src="../assets/images/layout/img-announcement-2.png" alt="img" className="img-fluid"></a>
               </div>
            </div> */}
            ...
            {/* <div className="card mb-3">
               <div className="card-body">
                  ...
                  <p className="text-muted">Do you know Able Pro is one of the featured dashboard template selected by Themeforest team.?</p>
                  <img src="../assets/images/layout/img-announcement-3.png" alt="img" className="img-fluid" />
               </div>
            </div> */}
            {/* <div className="card mb-3">
               <div className="card-body">
                  ...
                  <p className="text-muted">Get the lifetime free updates once you purchase the Able Pro.</p>
                  <img src="../assets/images/layout/img-announcement-4.png" alt="img" className="img-fluid" />
               </div>
            </div> */}
         </div>
    </div>
